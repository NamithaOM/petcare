...
function CustomerServiceRegister() {
  ...
  const handleReg = () => {
    ...
    if (!["Morning", "Night"].includes(shiftTiming)) {
      alert("Please select a valid shift timing.");
      return;
    }
    ...
    fetch("http://localhost:4000/auth/customerserviceregister", {
      method: "POST",
      headers: {
      ...
      <div className="auth-wrapper" style={bgStyle}>
        ...
        >
          ...
          <div className="row">
            ...
            >
              <div className="form-group mb-3">
                <label htmlFor="shiftTiming" className="text-white">
                  Shift Timing
                </label>
                <select
                  id="shiftTiming"
