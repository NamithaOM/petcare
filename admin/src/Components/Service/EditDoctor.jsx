        ...
        <div id="content">
          ...
          <div className="container-fluid">
            ...
            <form className="col-md-10" onSubmit={handleSubmit}>
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Experience</label>
                <div className="col-md-8">
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Qualification</label>
                <div className="col-md-8">
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Contact</label>
                <div className="col-md-8">
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Fees</label>
                <div className="col-md-8">
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Remarks</label>
                <div className="col-md-8">
                  <textarea
                    className="form-control"
                    name="remarks"
              ...
              <div className="form-group row">
                <label className="col-md-4 col-form-label">Photo</label>
                <div className="col-md-8">
                  Existing image:
                  <br />
                  {formData.photo && (
